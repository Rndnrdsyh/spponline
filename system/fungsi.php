...
class fungsi {
    ...
    public function deletekelas($id_kelas){
        ...
        $query = mysqli_query($this->kon(), $sql);
        header('location: admin.php?page=datakelas&status=berhasildihapus');
    ...
    public function deletespp($id_spp){
        ...
        $query = mysqli_query($this->kon(), $sql);
        header('location: admin.php?page=dataspp&status=berhasildihapus');
    ...
    public function deletepetugas($id_petugas){
        ...
        $query = mysqli_query($this->kon(), $sql);
        header('location: admin.php?page=datapetugas&status=berhasildihapus');
    ...
    public function deletesiswa($nisn){
        ...
        $query = mysqli_query($this->kon(), $sql);
        header('location: admin.php?page=datasiswa&status=berhasildihapus');
